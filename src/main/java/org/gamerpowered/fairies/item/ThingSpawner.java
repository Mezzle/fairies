package org.gamerpowered.fairies.item;
...
public class ThingSpawner extends ItemMonsterPlacer
{
    ...
    public ThingSpawner(String parEntityToSpawnName, int parPrimaryColor,
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
        ...
        {
            entityToSpawnNameFull = Fairies.MOD_ID + "." + entityToSpawnName;
